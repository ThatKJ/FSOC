...
- [x] `docs/MVP_METRICS.md` (consolidated real measured numbers, Stage 1-4 + frontend) + `docs/08_TELEMETRY_SCHEMA.md` / `docs/15_INTERFACE_CONTRACTS.md` / `docs/16_BASELINE_ACCEPTANCE.md` / `docs/17_DEMO_FREEZE.md` updated for the 34-column schema and `--mode` flag
